  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: OnboardingPagePresenter(pages: [
        ...
        OnboardingPageModel(
          title: 'Connect with branches.',
          description: 'Connect with the nearest branches to you.',
        ...
        OnboardingPageModel(
          ...
          description:
              'Everything manufactured in-house to ensure quality and consistency.',
          imageUrl: 'https://i.ibb.co/420D7VP/building.png',
          bgColor: const Color(0xfffeae4f),
        ),
        OnboardingPageModel(
          title: 'Follow up with vendors',
          description: 'Follow up with vendors to ensure timely delivery.',
          imageUrl: 'https://i.ibb.co/cJqsPSB/scooter.png',
